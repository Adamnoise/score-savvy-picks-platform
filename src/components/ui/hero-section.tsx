...
import { Mail, SendHorizontal, Menu, X, TrendingUp, Trophy, Users, Target } from "lucide-react";
...
const TipCard = ({ match, prediction, confidence, odds }: { match: string; prediction: string; confidence: number; odds: number }) => {
  return (
    <div className="bg-card p-6 rounded-2xl border">
      <div className="flex justify-between items-start mb-4">
        <div>
          <h3 className="font-medium text-lg">{match}</h3>
      ...
      <div className="flex items-center justify-between mt-4 pt-4 border-t">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="text-sm text-emerald-500">{odds}</div>
        </div>
      </div>
    </div>
  );
...
const menuItems = [
  { name: "Premium Tips", href: "#premium-tips" },
...
const HeroHeader = () => {
  ...
  return (
    <header>
      <nav data-state={menuState ? "active" : undefined} className="fixed group z-20 w-full px-2">
        <div
          className={cn(
        ...
        >
          <div className="relative flex flex-wrap items-center justify-between gap-6 py-3 lg:gap-0 lg:py-4">
            ...
            <div
              className={cn(
                "bg-background mb-6 hidden w-full flex-wrap items-center justify-end space-y-8 rounded-3xl border p-6 shadow-2xl shadow-zinc-300/20 md:flex-nowrap lg:m-0 lg:w-fit lg:gap-6 lg:space-y-0 lg:border-transparent lg:bg-transparent lg:p-0 lg:shadow-none dark:shadow-none dark:lg:bg-transparent",
                menuState && "block"
              )}
            >
      ...
      <div className="group relative m-auto max-w-6xl px-6">
        <div className="flex flex-col items-center md:flex-row">
          <div className="inline md:max-w-44 md:border-r md:pr-6">
            <p className="text-end text-sm">Trusted by professional bettors</p>
          </div>
